# traffic-light-mode-40-35-5-using-logisim_evolution
The program using logisim_evolution to build a traffic light for two traffic ways,east-west and north-south.It still has problems.
